...
urlpatterns = [
    ...
    url(r'^category/(?P<category_name_slug>[\w\-]+)/(?P<item_name_slug>[\w\-]+)/$', views.show_item, name='show_item'),
    url(r'^category/(?P<category_name_slug>[\w\-]+)/(?P<item_name_slug>[\w\-]+)/add_wishlist/$', views.add_wishlist, name='add_wishlist'),
